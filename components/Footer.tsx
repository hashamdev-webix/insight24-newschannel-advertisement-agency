        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              <a href="#" aria-label="Facebook" className="w-8 h-8 bg-[#333] hover:bg-[#dd0000] flex items-center justify-center transition rounded-sm">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
              </a>
              <a href="#" aria-label="Twitter / X" className="w-8 h-8 bg-[#333] hover:bg-[#dd0000] flex items-center justify-center transition rounded-sm">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="w-8 h-8 bg-[#333] hover:bg-[#dd0000] flex items-center justify-center transition rounded-sm">
              ...
              <a href="#" aria-label="YouTube" className="w-8 h-8 bg-[#333] hover:bg-[#dd0000] flex items-center justify-center transition rounded-sm">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
