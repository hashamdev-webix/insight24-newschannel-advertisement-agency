...
export async function generateStaticParams() {
  try {
    ...
    console.error("Failed to fetch slugs at build time:", error);
    return []; // Build fail nahi hogi
  }
}
      ...
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <main className="flex-1 max-w-7xl mx-auto px-4 py-12">
          <div className="text-center">
            <h1 className="text-3xl font-black text-[#1a1a1a] mb-4">
              Article Not Found
            </h1>
            ...
            <Link
              href="/"
              className="text-[#dd0000] hover:underline font-semibold"
            >
              ← Back to Home
            </Link>
          </div>
        ...
        <div className="bg-[#f5f5f5] border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-2.5">
            <div className="flex items-center gap-2 text-xs text-gray-500">
              <Link
                href="/"
                className="hover:text-[#dd0000] transition font-semibold"
              >
                Home
              </Link>
              <span>/</span>
              <Link
                ...
                className="hover:text-[#dd0000] transition font-semibold capitalize"
              >
                {article.categoryName || article.category}
              </Link>
              <span>/</span>
              <span className="text-[#1a1a1a] truncate font-semibold">
                {article.title}
              </span>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            <article className="lg:col-span-3">
              ...
              <div className="flex items-center justify-between py-4 border-y border-gray-200 mb-6">
                ...
                <div className="flex items-center gap-2">
                  <button className="w-8 h-8 rounded-full bg-[#1877f2] text-white flex items-center justify-center text-xs font-bold hover:opacity-90 transition">
                    f
                  </button>
                  <button className="w-8 h-8 rounded-full bg-[#1a1a1a] text-white flex items-center justify-center text-xs font-bold hover:opacity-90 transition">
                    𝕏
                  </button>
                  <button className="w-8 h-8 rounded-full bg-[#0077b5] text-white flex items-center justify-center text-xs font-bold hover:opacity-90 transition">
                    in
                  </button>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <p className="text-xs font-black text-[#1a1a1a] uppercase tracking-widest mb-3">
                  Share this story
                </p>
                <div className="flex items-center gap-3">
            ...
            <aside className="lg:col-span-1 space-y-6">
              {/* Sidebar Ad */}
              <div>
                <p className="text-[10px] text-gray-400 uppercase tracking-widest text-center mb-1">
                  Advertisement
                </p>
                ...
                <div className="border border-t-0 border-gray-200 divide-y divide-gray-200">
                  {trendingArticles.map((t, i) => (
                    <Link
                      ...
                      className="group flex gap-3 p-3 hover:bg-gray-50 transition"
                    >
                      <span className="text-lg font-black text-[#dd0000] w-5 shrink-0">
                        {i + 1}
                      </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {relatedArticles.map((related) => (
                  <Link
                    ...
                    className="group bg-white border border-gray-200 hover:shadow-md transition block"
                  >
                    ...
                    <div className="p-4">
                      <p className="text-[10px] font-bold text-[#dd0000] uppercase tracking-wider mb-1">
